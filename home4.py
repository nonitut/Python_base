...
# Есть такой словарь, это валюты и их стоимость на какой-то год
...
testvalut = input("Введите название валюты: ")

if testvalut in list(currencies.keys())  : 
    print(currencies[testvalut])


else :
    print(" Упс, какая то ошибка ... ")
